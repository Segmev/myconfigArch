...
tyrannical.tags = {
   ...
   } ,
   {
      ...
      class ={ 
	 "Kate", "KDevelop", "Codeblocks", "Code::Blocks" , "DDD", "kate4", "Emacs", "jetbrains-studio", "Visual Studio Code", "Code", "vscode", "atom",
      }
   } , 
   {
      name        = "Internet",
...
globalkeys = awful.util.table.join(
   ...
   -- My bindings
   awful.key({ modkey, }, "w", function () awful.tag.delete() end),
   awful.key({ modkey,           }, "c",
      function ()
...
--   awful.key({ modkey,           }, "F1", function () awful.util.spawn_with_shell("atom &") end),
   awful.key({ modkey,           }, "a",  function () awful.util.spawn_with_shell("emacs &") end),
   awful.key({ modkey, "Shift"   }, "F3", function () awful.util.spawn_with_shell("firefox-aurora &") end),
   awful.key({ modkey,           }, "F2", function () awful.util.spawn_with_shell("thunar &") end),
   awful.key({ modkey,           }, "d", function () awful.util.spawn_with_shell("dmenu_extended_run &") end),
   awful.key({ modkey, "Control" }, "l", function () awful.util.spawn_with_shell("~/bin/i3lock.sh &") end),   

   -- Switch layout
   awful.key({ "Mod1",           }, "Shift_L" ,  function () awful.util.spawn_with_shell("~/bin/switchLayout.sh")end ),
...
awful.util.spawn_with_shell("awful.util.spawxmodmap ~/.Xmodmap")
